...
**Author-reported historical trials** (`claude-haiku-4-5`, September 16): these
counts have no committed raw receipts or source hashes and have not been independently
rerun after the unavailable-verdict scoring repair. The current runners report
`UNAVAILABLE` separately and exit nonzero; an unavailable SKIP case is not correct.
...
The author's reported interpretation was that precision did not collapse on unstated
reasons in these small trials. This is not verified current model performance. The
...
**Historical window-construction observation, not independently rerun.** An
